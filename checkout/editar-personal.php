...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    try {
        ...
        header("Location: ../pages/ver-personal.php?statuss=success");
        exit;

    } catch (PDOException $e) {
        header("Location: ../pages/ver-personal.php?statuss=error&msg=" . urlencode($e->getMessage()));
        exit;
    }
}
?>
...
<div class="col-sm-6">
  ...
  <input type="number" max="100000" min="0" class="form-control" id="cp" name="cp" placeholder="" value="<?php echo $personal['CP']; ?>">
