...
<h4>Datos de Contacto</h4>
    ...
    <div class="col-sm-6">
        <label for="emailRespaldo" class="form-label">Correo electrónico de respaldo<span class="text-body-secondary">(Opcional)</span></label>
         <div class="input-group has-validation">
        <span class="input-group-text">@</span>
        <input type="text" class="form-control" maxlength="50" id="emailRespaldoS" name="emailRespaldo" placeholder="you@example.com" value="<?php echo $usuario['EmailRespaldo']; ?>"><br>
    </div>
</div>
