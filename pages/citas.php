...
try {
    ...
    $query = "SELECT Nombre, ApellidoPaterno, ApellidoMaterno, FechaNacimiento, Edad, Sexo, comunidadLGBT, Estadocivil, LugarNacimiento, LenguaMaterna, LenguaIndigena, FechaRegistro
              FROM usuario 
              WHERE id = :usuario_id
              LIMIT 1";
