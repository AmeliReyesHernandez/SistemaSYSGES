  ...
  <body>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
      ...
      <div class="sf-header shadow-sm">
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3">
          ...
          <div class="d-flex flex-wrap gap-2">
            <a href="../checkout/register-donante.php" class="btn btn-outline-purple btn-sm px-3 py-2 fw-semibold">
              <i class="bi bi-person-plus-fill me-1"></i> Nuevo Donante
            </a>
            <a href="../checkout/register-donativo.php" class="btn btn-purple btn-sm px-3 py-2 fw-semibold shadow-sm">
      ...
      <ul class="nav sf-nav-tabs">
        <li class="nav-item">
          <a class="nav-link active" href="donaciones-dashboard.php"><i class="bi bi-grid-1x2-fill me-1"></i> Inicio</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="ver-donantes.php"><i class="bi bi-people-fill me-1"></i> Directorio de Donantes</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="ver-donaciones.php"><i class="bi bi-coin me-1"></i> Historial de Donaciones</a>
        </li>
      </ul>
        ...
        <div class="col-lg-4">
          ...
          <div class="card-sf">
            <div class="card-sf-header">
              ...
              <a href="ver-donantes.php" class="btn btn-sm btn-link text-decoration-none p-0">Ver todos</a>
            </div>
        ...
        <div class="col-lg-5">
          ...
          <div class="card-sf">
            <div class="card-sf-header">
              ...
              <a href="ver-donaciones.php" class="btn btn-sm btn-link text-decoration-none p-0">Ver listado</a>
            </div>
            <div class="card-body p-0">
        ...
        <div class="col-lg-3">
          ...
          <div class="card-sf">
            ...
            <div class="card-body d-flex flex-column gap-2">
              <a href="../checkout/register-donativo.php" class="btn btn-outline-primary text-start d-flex align-items-center gap-2 py-2">
                <i class="bi bi-plus-circle-fill text-primary"></i> Registrar Nueva Donación
              </a>
              <a href="../checkout/register-donante.php" class="btn btn-outline-purple text-start d-flex align-items-center gap-2 py-2">
                <i class="bi bi-person-plus-fill"></i> Registrar Nuevo Donante
              </a>
              <a href="ver-donaciones.php" class="btn btn-outline-success text-start d-flex align-items-center gap-2 py-2">
    ...
    <div class="modal fade" id="modalEnviarCorreo" tabindex="-1" aria-labelledby="modalEnviarCorreoLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow">
          ...
          <form action="../checkout/correo.php" method="POST">
